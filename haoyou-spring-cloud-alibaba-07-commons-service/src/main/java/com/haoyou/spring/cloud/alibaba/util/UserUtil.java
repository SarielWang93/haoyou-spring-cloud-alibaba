...
public class UserUtil {
    ...
    //登录额外信息
    public void otherMsg(User login) {
        ...
        //未读邮件数量
        TreeMap<Date, Email> emails = this.getEmails(login);
        int i = 0;
        ...
        //好友数量
        List<Friends> friends = this.getFriends(login.getUid());
        ...
        //闯关模式进度
        List<Badge> badges = this.getBadges(login);
